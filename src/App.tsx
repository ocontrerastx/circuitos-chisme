...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Fetch Live Race Intel from OpenF1
      ...
      try {
        ...
        if (meetings && Array.isArray(meetings)) {
          ...
          const currentMeetingIndex = sortedMeetings.findIndex((m) => {
            ...
            raceEndBuffer.setHours(23, 59, 59);
          ...
          if (meeting) {
            ...
            const cleanName = meeting.meeting_name
  ...
  return (
    <div className="bg-[#0e0e13] text-[#f8f5fd] font-['Newsreader'] selection:bg-[#00f4fe] selection:text-[#0e0e13] overflow-x-hidden min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center py-16 px-6 md:px-10 bg-slate-950/80 backdrop-blur-xl h-20 -rotate-1 origin-left border-b-4 border-cyan-400 shadow-[8px_8px_0px_0px_rgba(255,137,171,0.3)]">
        <div className="text-2xl md:text-3xl font-black italic tracking-tighter text-pink-500 hover:skew-x-12 transition-transform font-headline cursor-pointer">
          Circuitos y Chisme
        </div>
        <div className="hidden lg:flex gap-8 items-center font-headline uppercase tracking-tighter">
          {[
            { label: "Episodes", href: "#", external: false },
            // { label: "About", href: "#", external: false },
            { label: "Spotify", href: PODCAST_LINKS.spotify, external: true },
            {
            ...
            <a
              key={item.label}
              className={`${idx === 0 ? "text-cyan-400 border-b-4 border-cyan-400 pb-1" : "text-slate-100"} hover:text-pink-400 hover:-rotate-2 hover:scale-105 transition-all duration-150`}
              href={item.href}
        ...
        <button className="bg-[#ff89ab] text-black font-headline font-black px-4 md:px-6 py-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-1 hover:shadow-none transition-all active:translate-y-1">
          SUBSCRIBE
        </button>
      </nav>
      ...
      <main className="pt-32">
        ...
        <section className="py-24 bg-[#e30071] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <h4 className="font-body italic text-4xl md:text-5xl text-black leading-tight">
                "We're diving deep into the seat swaps no one saw coming and why
                the paddock vibe is absolutely electric this year."
              </h4>
        ...
        {/* Social Grid - Updated TikTok & Instagram Focus */}
        <section className="py-24 px-6 bg-[#0e0e13]">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              {/* TikTok - Primary Hierachy */}
              <a
